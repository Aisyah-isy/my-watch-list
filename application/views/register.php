...
<head>
    ...
    <title>Register to MyWatchlist</title>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Your List starts here 🚀</h4>
                        <p class="mb-4">Make your Watchlist Fun!</p>
                        
                        <form id="formAuthentication" class="mb-2" action="<?= site_url('auth/register') ?>" method="post">
                            <div class="mb-3">
