...
>
  <head>
    ...
    <title>Log in to MyWatchlist</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">MWL</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome Back to MyWatchlist! 👋</h4>
              <p class="mb-4">Please log in to your account!</p>
              
              <form id="formAuthentication" class="mb-3" action="<?= site_url("auth/auth") ?>" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <button type="submit" class="btn btn-primary d-grid w-100" type="submit">Log in</button>
                </div>
              </form>
